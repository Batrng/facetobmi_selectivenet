...
if __name__ == "__main__":
    ...
    p = pickle.load(open('C:/Users/nguyen/Downloads/val.pickle', 'rb'), encoding='latin1')
    #print(str(p["image_id"][300000]))
    print(len((p["image_id"])))
    
    #for i, img_id in enumerate(p["image_id"][38781:], start=38781):
    for i, img_id in enumerate(p["image_id"][2500:], start=2500):
        index = i
        print(i)
