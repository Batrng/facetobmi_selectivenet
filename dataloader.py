...
def get_dataloaders(batch_size=16, augmented=True, vit_transformed=True, show_sample=False):
    bmi_dataset = BMIDataset('/home/nguyenbt/nobackup/face-to-bmi-vit/height.csv', '/home/nguyenbt/nobackup/data/2019_Mhse_Height_Data/combined_fullbody/', '/home/nguyenbt/nobackup/data/2019_Mhse_Height_Data/combined_face/', 'bmi', ToTensor())
    if show_sample:
